...
\noindent\citet{umbach2009a_comp} fleshes out \citeauthor{koenig1977}'s \citeyearpar{koenig1977} proposal and concludes that the role reversal is due to different syntactic structures. In a comparative reading \textit{noch} combines with an AP \Vref{NOCH_COMP_EXP}{$'$} and in a marginality reading \textit{noch} combines with a DegP \Vref{NOCH_MARG_EXP}{$'$}.


\ex.[\Vref{NOCH_COMP_EXP}{$'$}] [$_{\textnormal{\footnotesize{CP}}}$ Maria [$_{\textnormal{\footnotesize{VP}}}$ ist [$_{\textnormal{\footnotesize{DegP}}}$ \textbf{[$_{\textbf{\footnotesize{AP}}}$ noch [$_{\textbf{\footnotesize{AP}}}$ größer ]]} [als Adam]]]] 

\ex.[\Vref{NOCH_MARG_EXP}{$'$}] [$_{\textnormal{\footnotesize{CP}}}$ Maria [$_{\textnormal{\footnotesize{VP}}}$ ist \textbf{[$_{\textbf{\footnotesize{DegP}}}$ noch [$_{\textbf{\footnotesize{DegP}}}$ [$_{\textbf{\footnotesize{AP}}}$ größer] [als Peter]]]} ]] \flushright (taken and adapted from \citeauthor{umbach2009a_comp} \citeyearpar{umbach2009a_comp}, her (17b.) and (18b.))
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.495\textwidth}
        \includegraphics[width=0.85\textwidth, height=0.85\linewidth]{boxplot.pdf}
    \end{minipage}
    \begin{minipage}{0.495\textwidth}
        \includegraphics[width=0.85\textwidth, height=0.85\linewidth]{boxplot_ztrans.pdf}
...
\begin{figure}[H]
    \centering
    \begin{minipage}{0.495\textwidth}
        \includegraphics[width=0.85\textwidth, height=0.85\linewidth]{cd1_hg.pdf}
    \end{minipage}
    \begin{minipage}{0.495\textwidth}
        \includegraphics[width=0.85\textwidth, height=0.85\linewidth]{cd2_hg.pdf}
    \end{minipage}

    \begin{minipage}{0.495\textwidth}
        \includegraphics[width=0.85\textwidth, height=0.85\linewidth]{cd3_hg.pdf}
    \end{minipage}
    \begin{minipage}{0.495\textwidth}
        \includegraphics[width=0.85\textwidth, height=0.85\linewidth]{cd4_hg.pdf}
...
\begin{figure}[H]
\includegraphics[width=1\textwidth]{LF-mod_comp}
...
\textit{`There is neither boundary nor measure to which he disturbs the country as he causes it trouble and to the entire world.'} \flushright\vspace{-9pt} (Otfried DDD\_O\_Otfr.Ev.4.20 (edition 278 - 289) via ANNIS.) % 1.OG2.OtfEbKell.281.27
...
\begin{figure}[H]
\includegraphics[width=1\textwidth]{LF0_temp}
...
\begin{figure}[H]
\includegraphics[width=1\textwidth]{LF1_temp_>_over_noch}
...
\begin{figure}[H]
\includegraphics[width=1\textwidth]{LF2_comp}
...
\begin{figure}[H]
\includegraphics[width=1\textwidth]{LF3_comp}
...
%\bibliographystyle{langsci-unified.bst}
