...
The synchronic data meet predictions 2 and 3 as we have shown in \sectref{sec:kellert:2} (see examples (7-8)). Other predictions are tested in the following section.
