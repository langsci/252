...
The synchronic data was taken from the Corpus del Español (\nocite{CDE}CDE) Web/Dialects: Mark, Davies. Corpus del Español. {[}\href{http://www.corpusdelespanol.org/}{http://www.corpusdelespanol.org/}{]}, November 2017. 468 occurrences of \textit{equis} have been extracted from the synchronic corpus and classified according to syntactic and semantic/pragmatic features.
