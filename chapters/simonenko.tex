...
%\bibliography{/Users/alexandra/Documents/Bibliography/library} 
\addbibresource{/Users/alexandra/Documents/Bibliography/library.bib}%use biber as BibTex engine
...
%end semantic brackets

\title{Givenness marking in a mixed system:\\ Constituent order vs. determiners} 
\author{%
Alexandra Simonenko\affiliation{Research Foundation Flanders \& Ghent University}
}
...
\begin{figure}[H]
\includegraphics[scale = 0.4]{pictures/plotLiteralListenerSbjObjUniform}
...
\begin{figure}[H]
\includegraphics[scale = 0.45]{pictures/plotPragmaticSpeakerGivenGivenUniform}
\caption{\small Pragmatic Speaker with uniform priors conveying Given $\succ$ Given}\label{figure:uniform2}
\end{figure}

\begin{figure}[H]
\includegraphics[scale = 0.45]{pictures/plotPragmaticSpeakerGivenNewUniform}
\caption{Pragmatic Speaker with uniform priors conveying Given $\succ$ New}\label{figure:uniform3}
\end{figure}

\begin{figure}[H]
\includegraphics[scale = 0.45]{pictures/plotPragmaticSpeakerNewNewUniform}
...
\begin{figure}[H]
\includegraphics[scale = 0.45]{pictures/plotPragmaticListenerSbjObjUniform}
...
\begin{figure}[H]
\includegraphics[scale = 0.45]{pictures/plotFrenchSbjObj}
...
\begin{figure}[H]
\includegraphics[scale = 0.45]{pictures/plotRussianSbjObj}
...
\begin{figure}[H]
\includegraphics[scale = 0.45]{pictures/plotModelComparison}
...
\begin{figure}[H]
\includegraphics[scale = 0.45]{pictures/determiners.pdf}
...
\begin{figure}[H]
\includegraphics[scale = 0.55]{pictures/determinersOrders.pdf}
