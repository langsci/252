...
On the basis of Lahiri's (\citeyear{Lahiri98}) analysis of Hindi {\emph{ek bhii}} `one-even', the meaning of emphatic `even-one' NPIs is formalized by \citet[156]{Chierchia:2013} as follows, using the probability measure already seen in (\ref{scalarpresupposition}):
